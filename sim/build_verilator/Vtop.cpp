...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , smp_clr{vlSymsp->TOP.smp_clr}
    , set_clr{vlSymsp->TOP.set_clr}
    , smp_en{vlSymsp->TOP.smp_en}
    , state{vlSymsp->TOP.state}
    , label{vlSymsp->TOP.label}
    , predict{vlSymsp->TOP.predict}
    , im_value{vlSymsp->TOP.im_value}
    , im_pos{vlSymsp->TOP.im_pos}
    , rootp{&(vlSymsp->TOP)}
{
